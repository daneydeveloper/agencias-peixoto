$(function() {"use strict";
	...
	if ($('#map-view').length) {
		...
		//41.828597, -73.762763
		var pos = new google.maps.LatLng(-3.7528037,-38.5037672);
		...
		var pos1 = new google.maps.LatLng(-3.738557,-38.523897); 
		var pos2 = new google.maps.LatLng(-3.738557,-38.523897);
		var pos3 = new google.maps.LatLng(-3.738557,-38.523897);
		var pos3 = new google.maps.LatLng(-3.738557,-38.523897);
		var pos3 = new google.maps.LatLng(-3.738557,-38.523897);
		var pos3 = new google.maps.LatLng(-3.738557,-38.523897);
	...
	if ($('#map-view1').length) {
		...
		var pos = new google.maps.LatLng(-3.7536816, -38.5051203);
		...
		var pos1 = new google.maps.LatLng(-3.7536816, -38.5051203);
